                ...
                foreach ($rst as $row) {
                    ...
                    <tr>
                        ...
                        if ($row['dato'] == 1) {
                            ...
                            <th>No aplica</th>
                            <th>No aplica</th>
                            <th><?php echo($row['pdf'] != NULL ? "<a href=\"../".$row['pdf']."\" target=\"_blank\"><i class=\"fa fa-file-pdf-o\" aria-hidden=\"true\" style=\"font-size: 2em;\"></i></a><br/><br/><a data-toggle=\"modal\" data-target=\"#myModal\" data-remote=\"cat_documentacion_upload.php?xCveExpediente=" . $row['cve_expediente'] . "&xTipo=2\" href=\"javascript:void(0);\">Cambiar documento</a>" : "<a data-toggle=\"modal\" data-target=\"#myModal\" data-remote=\"cat_documentacion_upload.php?xCveExpediente=" . $row['cve_expediente'] . "&xTipo=2\" href=\"javascript:void(0);\">Subir documento</a>"); ?></th>
                            <?php
                        }
                        ?>
                        <th><button type="button" class="btn btn-danger" id="btnEliminar" name="btnEliminar" onclick="eliminar(<?PHP echo $row['cve_expediente']; ?>);"><span class="glyphicon glyphicon-trash"></span> Eliminar</button></th>
                    </tr>
                <?php } $rst->closeCursor();
                ?>
            </tbody>
