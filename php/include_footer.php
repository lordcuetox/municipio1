...
<div class="row top-buffer" id="contacto" >
    ...
    <div class="row top-buffer">
        <div class="col-md-3 text-left">
            <img src="<?php echo($path);?>Recursos/Archivo comprimido/logo_indferior.png" alt="H. Ayuntamiento de Macuspana 2016-2018" style="margin-left:15px;"/>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3 text-right">
            <img src="<?php echo($path);?>Recursos/Archivo comprimido 2 Macusp/logo_gobtab.png" alt="Gobierno del Estado de Tabasco" style="margin-right:15px;"/>
        </div>
        <div class="clearfix visible-md-block"></div>
    </div>
    <div class="clearfix visible-md-block"></div>
