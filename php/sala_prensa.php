            ...
            <div class="row">
                ...
                <div class="col-md-12" style="margin-top: 10px;" >
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="visible-md visible-lg"><a href="javascript:void(0);" data-toggle="modal" data-remote="boletin_informativo_5.php?o=<?php echo($origin);?>" data-target="#mDetalleBoletin" class="btn btn-success">Leer más</a></div>
                        <div class="visible-xs visible-sm text-center"><a href="javascript:void(0);" data-toggle="modal" data-remote="boletin_informativo_5.php" data-target="#mDetalleBoletin" class="btn btn-success">Leer más</a></div>
